...
****************************************************************************  */
window.initCustomGSAP = function () {
  ...
  // Mobile menu functionality is now handled by Angular components
  // This section is commented out to prevent conflicts with Angular implementation
  ...
  */
  ...
  // **************************** Banner js start ****************************
  if (document.querySelectorAll('.flower').length) {
    gsap.from(".flower", {
      scale: 0,
      x: 50,
      y: 50,
  ...
  if (document.querySelectorAll('.ball').length) {
    gsap.from(".ball", {
      y: -140,
      ease: "bounce.out",
      duration: 1.8,
  ...
  if (document.querySelectorAll('.drag-rotate-element').length) {
