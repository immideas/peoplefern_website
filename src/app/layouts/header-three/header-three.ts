import { Component, OnInit, OnDestroy, HostListener, ElementRef, Renderer2, ViewChild, Inject, PLATFORM_ID } from '@angular/core';
...
@Component({
  ...
  imports: [NavMenuThree, RouterLink],
  standalone: true,
  templateUrl: './header-three.html',
  styleUrls: ['./header-three.scss']
})
export class HeaderThree implements OnInit, OnDestroy {
